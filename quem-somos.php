...
<head>
    ...
    <link  rel="stylesheet" href ="../ProjetoDH/css/style-quem-somos.css">
    <title>SurfWin</title>
           ...
           <h3>| </h3>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
              ...
              <form class="form-inline my-2 my-lg-0">
                <button class="btn my-2 my-sm-0" type="submit"><img src="../ProjetoDH/css/img/header/login.png" height="35" width="35"alt="botão de LogIn"></button>
